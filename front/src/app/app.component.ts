...
export class AppComponent {
  postCollection: HalCollection<Post>;
  tagCollection: HalCollection<Tag>;
  ...
  fetch() {
    this.http
      .get<HalCollection<Post>>(environment.api + "/api/posts")
      .subscribe(postCollection => {
        this.postCollection = postCollection;
      });

    this.http
      .get<HalCollection<Tag>>(environment.api + "/api/tags")
